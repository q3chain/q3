...
#ifndef q3chain_RPCPROTOCOL_H
#define q3chain_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! q3chain is not connected
...
std::string FormatFullq3chainVersion();

#endif // q3chain_RPCPROTOCOL_H

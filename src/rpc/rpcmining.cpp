...
/* MCHN START */                
    ...
    else // Not -regtest: start generate thread, return immediately
    {
        ...
        Generateq3chains(fGenerate, pwalletMain, nGenProcLimit);
    }
...
Value prioritisetransaction(const Array& params, bool fHelp)
{
    ...
    throw JSONRPCError(RPC_NOT_SUPPORTED, "Transaction prioritization is not supported in this version of q3chain");        
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    throw JSONRPCError(RPC_NOT_SUPPORTED, "getblocktemplate is not supported in this version of q3chain");        
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "q3chain is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "q3chain is downloading blocks...");

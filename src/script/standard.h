...
#ifndef q3chain_SCRIPT_STANDARD_H
#define q3chain_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a Cq3chainAddress
 */
...
/* MCHN END */
#endif // q3chain_SCRIPT_STANDARD_H

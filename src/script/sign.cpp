...
void q3chainNode_AddSignatureToCache(const std::vector<unsigned char>& vchSig, const CPubKey& pubkey, const uint256& sighash);
...
/* MCHN END */    
    ...
    {
        q3chainNode_AddSignatureToCache(vchSig,key.GetPubKey(),hash);
    }

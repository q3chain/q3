...
#ifndef q3chainPARAMLIST_H
#define q3chainPARAMLIST_H

static const mc_Oneq3chainParam q3chainParamArray[] =
{
    { "chainprotocol"                          , "chain-protocol"                          ,
                   ...
                   "Chain protocol: q3chain (permissions, native assets) or q3chain"},
...
*/                   
    ...
    { "chainname"                              , "chain-name"                              ,
                   ...
                   "protocolversion","",
                   "Chain name, used as first argument for q3chaind and q3chain-cli."},                   

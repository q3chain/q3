...
#ifndef q3chain_CHAINPARAMS_H
#define q3chain_CHAINPARAMS_H
 ...
 * q3chain system. There are three: the main network on which people trade goods
...
public:
    ...
    /** Used if Generateq3chains is called with a negative number of threads */

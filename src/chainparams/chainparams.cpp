...
/* MCHN START */
static Checkpoints::MapCheckpoints mapCheckpointsq3chain =
        boost::assign::map_list_of
        ( -1, uint256("0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"))
        ;
static const Checkpoints::CCheckpointData dataq3chain = {
        &mapCheckpointsq3chain,
        0,
        0,
        0
    };
...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("q3chain.sipa.be", "seed.q3chain.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.q3chain.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("q3chainstats.com", "seed.q3chainstats.com"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("q3chain.petertodd.org", "testnet-seed.q3chain.petertodd.org"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "testnet-seed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("q3chain.schildbach.de", "testnet-seed.q3chain.schildbach.de"));
...
class Cq3chainParams : public CMainParams {
public:
    Cq3chainParams() {    };
    
    void SetFixedParams(const char *NetworkName)
    {
        networkID = CBaseChainParams::q3chain;
...
//        convertSeed6(vFixedSeeds, pnSeed6_test, ARRAYLEN(pnSeed6_test));
    ...
    void Setq3chainParam(const char*param_name,int64_t value)
    {
...
static Cq3chainParams q3chainParams;


bool Selectq3chainParams(const char *NetworkName)
{
    Selectq3chainBaseParams(NetworkName,(int)mc_gState->m_NetworkParams->GetInt64Param("defaultrpcport"));

    q3chainParams.SetFixedParams(NetworkName);
    
    q3chainParams.Initialize();
    
    pCurrentParams = &q3chainParams;
...
void Setq3chainParams()
{
    q3chainParams.Setq3chainParams();
}

void Setq3chainParam(const char*param_name,int64_t value)
{
    q3chainParams.Setq3chainParam(param_name,value);
}


void Setq3chainRuntimeParams()
{
    q3chainParams.Setq3chainRuntimeParams();
}

bool Initializeq3chainParams()
{
    
    q3chainParams.Initialize();
    
    q3chainParams.SetGenesis();

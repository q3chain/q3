...
#ifndef q3chain_STATE_H
#define	q3chain_STATE_H

#include "utils/define.h"
#include "chainparams/params.h"
#include "protocol/q3chainscript.h"
...
{    
    const mc_Oneq3chainParam *m_Param;
    int64_t m_Value;    
    uint32_t m_Block;
    int32_t m_Skipped; 
...
{    
    ...
    mc_Params               *m_Params;
    mc_q3chainParams     *m_NetworkParams;
    ...
    void  InitDefaults()
    {
        ...
        m_NetworkParams=new mc_q3chainParams;
        m_Permissions=NULL;
        m_Assets=NULL;

...
// Copyright (c) 2014-2020 The q3chain Core developers
...
//    bool m_strongly_seeded GUARDED_BY(m_mutex) = false;
    ...
    CCriticalSection cs_events;
    CSHA256 m_events_hasher;
...
static void SeedPeriodic(CSHA512& hasher, RNGState& rng) noexcept
{
    ...
    LogPrint("rand", "Feeding %i bytes of dynamic environment data into RNG\n", hasher.Size() - old_size);
...
static void SeedStartup(CSHA512& hasher, RNGState& rng) noexcept
{
    ...
    LogPrint("rand", "Feeding %i bytes of environment data into RNG\n", hasher.Size() - old_size);

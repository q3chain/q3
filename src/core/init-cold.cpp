...
/* MCHN END */    
    ...
    strUsage += "  -hideknownopdrops=<n>                    " + strprintf(_("Remove recognized q3chain OP_DROP metadata from the responses to JSON_RPC calls (default: %u)"), 0) + "\n";
            ...
            if(currentwalletdatversion != 1)
            {
                ...
                if(env_cur.MinWalletDBVersion() > currentwalletdatversion)
                {
                    return InitError(strprintf("Wallet version %d is not supported in this build of q3chain.\n\n"
                            ...
                            "q3chaind-cold %s -walletdbversion=%d\n",
            ...
            if( (currentwalletdatversion == 2) )
            {
                ...
                else
                {
                    return InitError(strprintf("Wallet version %d is not supported in this version of q3chain.\n\n"
                            ...
                            "q3chaind-cold %s -walletdbversion=3\n",
